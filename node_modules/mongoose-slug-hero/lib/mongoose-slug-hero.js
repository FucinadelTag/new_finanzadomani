...
function SlugHero (schema, options) {
  ...
  // --------- options --------- //
    ...
    slugFieldName = options.slugField || options.slugFieldName || SlugHero.config.slugField || SlugHero.config.slugFieldName,

    // field name for storing slugs (optional / global)
    slugsFieldName = options.slugsField || options.slugsFieldName || SlugHero.config.slugsField || SlugHero.config.slugsFieldName,
